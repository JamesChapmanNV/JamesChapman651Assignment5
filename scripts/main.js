...
function averageAge (num1, num2, num3) {
    if(num3 == undefined) return Math.round((num1 + num2) / 2);
    else return Math.round((num1 + num2 + num3) / 3);
}
*/
let averageAge = (num1, num2, num3) => (num3 == undefined) ? 
    Math.round((num1 + num2) / 2) : Math.round((num1 + num2 + num3) / 3);
...
let leetSpeak = word => word.replaceAll('e','3').replaceAll('a','4');
